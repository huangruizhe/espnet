...
class ConstrainedBeamSearch(BeamSearch):
    ...
    def constraints_satisfied_post_process2(self, hyp, constraints_satisfied):
        # only allows words in the vocab, 
        # while also boost the keywords
        hyp_word_scores = []
        satisfied_scores = []
        weight = 2.0
        for i, cs_val in enumerate(constraints_satisfied):
