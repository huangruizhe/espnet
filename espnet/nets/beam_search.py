...
class Hypothesis(NamedTuple):
    ...
    score_t: Union[float, torch.Tensor] = 0   # hypothesis prob mass (temperatured and normalized) for sampling
    G: Union[float, torch.Tensor] = 0   # gumbel variable since the last symbol
