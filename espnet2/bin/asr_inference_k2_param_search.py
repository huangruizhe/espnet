...
class k2Speech2Text:
    ...
    def __call__(
        ...
        while (lattices[0].num_arcs > 500000 and lattices[0].shape[0] > 100000) or \
            lattices[0].num_arcs > 1000000 or lattices[0].shape[0] > 200000:
            sbeam_size = max(10, int(sbeam_size * 0.9))
            obeam_size = max(10, int(obeam_size * 0.9))
            max_states = int(max_states * 0.9)
        ...
        if best_paths is not None:
            # best_path_aux_labels = best_paths[0].aux_labels.tolist()   # word labels
            best_path_aux_labels = best_paths[0].tokens.tolist()       # token labels
...
def inference(
    ...
    with DatadirWriter(output_dir) as writer:
        ...
        for batch_idx, (keys, batch) in enumerate(loader):
            ...
            # # if keys[0] != 'sw02010-A_027127-028879':
            ...
            if best_path_aux_labels is not None:
                ...
                best_writer = writer["1best_recog"]
                best_writer["best_path_aux_labels"][key] = ""
